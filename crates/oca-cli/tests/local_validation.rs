...
/// Every parser arm must reject malformed refs before execution can open a
/// transport, including all non-canonical character classes.
#[test]
fn expanded_malformed_ref_matrix_fails_at_the_parser_boundary() {
    let malformed = [
        "",        // empty
        "x4f2a1",  // wrong prefix
        "w4f2a",   // wrong length
